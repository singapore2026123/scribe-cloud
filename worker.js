...
const GT = { en: "en", ja: "ja", zh: "zh-CN", "zh-CN": "zh-CN", ms: "ms", ta: "ta", my: "my", ko: "ko", th: "th", id: "id", vi: "vi", hi: "hi", fr: "fr", yue: "yue", nan: "zh-CN" };
...
const PROMPTS = {
  ja: "医療・介護記録。用語：気管吸引、口腔吸引、経鼻経管栄養、経管栄養、入浴、部分浴、清拭、清潔操作、移乗介助、体位変換、口腔ケア、尿道カテーテル、創傷ケア、おむつ交換、排泄介助、点眼、服薬介助、酸素療法、血圧、脈拍、体温、呼吸数、酸素飽和度、血糖、褥瘡、誤嚥、認知症、糖尿病、高血圧、脳卒中、誤嚥性肺炎、便秘、脱水、転倒、骨折、尿路感染症、介護士、看護師、医師、理学療法士、咳、くしゃみ、発熱、腫れ、出血、嘔吐、めまい、発疹、包帯。",
  zh: "医疗护理记录。术语：气管吸引、口腔吸引、鼻胃管喂食、管饲、洗澡、局部清洗、擦身、清洁操作、转移协助、翻身、口腔护理、导尿管、伤口护理、换尿布、如厕协助、滴眼药、给药、氧疗、血压、脉搏、体温、呼吸频率、血氧饱和度、血糖、褥疮、误吸、失智症、糖尿病、高血压、中风、吸入性肺炎、便秘、脱水、跌倒、骨折、尿路感染、护理员、护士、医生、物理治疗师、咳嗽、喷嚏、发烧、肿胀、出血、呕吐、头晕、皮疹、绷带。",
  ms: "Rekod penjagaan perubatan. Istilah: sedutan trakea, sedutan mulut, pemakanan melalui tiub, mandi, mandi separa, lap badan, teknik aseptik, bantuan pemindahan, tukar kedudukan, penjagaan mulut, kateter kencing, penjagaan luka, tukar lampin, bantuan ke tandas, titis mata, pemberian ubat, terapi oksigen, tekanan darah, kadar nadi, suhu badan, kadar pernafasan, ketepuan oksigen, gula darah, luka baring, aspirasi, demensia, kencing manis, darah tinggi, strok, sembelit, dehidrasi, jatuh, patah tulang, penjaga, demam, batuk, bersin, bengkak, pendarahan, muntah, pening, ruam, pembalut.",
  ta: "மருத்துவ பராமரிப்பு பதிவு. சொற்கள்: வாய் உறிஞ்சுதல், குழாய் மூலம் ஊட்டுதல், குளிப்பாட்டுதல், பகுதி குளியல், உடல் துடைத்தல், தூய்மை நுட்பம், இடமாற்ற உதவி, உடல் நிலை மாற்றுதல், வாய் பராமரிப்பு, சிறுநீர்க் குழாய், காயம் பராமரிப்பு, டயப்பர் மாற்றுதல், கழிப்பறை உதவி, கண் சொட்டு மருந்து, மருந்து வழங்கல், ஆக்ஸிஜன் சிகிச்சை, இரத்த அழுத்தம், நாடித் துடிப்பு, உடல் வெப்பநிலை, சுவாச விகிதம், ஆக்ஸிஜன் செறிவு, இரத்த சர்க்கரை, படுக்கைப் புண், மறதி நோய், நீரிழிவு நோய், உயர் இரத்த அழுத்தம், இருமல், தும்மல், காய்ச்சல், வீக்கம், இரத்தப்போக்கு, வாந்தி, தலைச்சுற்றல், தடிப்பு, கட்டு.",
};
